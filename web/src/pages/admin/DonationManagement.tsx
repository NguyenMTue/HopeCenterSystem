...
const DonationManagement: React.FC = () => {
  ...
  const columns = [
    ...
    { 
      ...
      key: 'type',
      render: (type: any) => {
        // Kiểm tra nếu type bị null hoặc undefined thì gán giá trị mặc định là "N/A"
        const displayType = type ? String(type) : 'N/A';
        const isCash = displayType === 'Tiền mặt' || displayType === 'Cash';
